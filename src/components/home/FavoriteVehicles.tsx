...
export const FavoriteVehicles = () => {
  ...
  return (
    <AnimatedSection className="pb-2 pt-1" delay={0}>
      <div className="mb-5">
        <span className="inline-flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.18em] text-rose-600/90">
          <span className="h-[3px] w-10 rounded-full bg-gradient-to-r from-rose-500 to-pink-400" />
          Coups de cœur
        </span>

        <h2 className="mt-3 text-2xl font-bold tracking-tight text-slate-950 sm:text-[1.8rem]">
          Les véhicules que les voyageurs apprécient le plus
        </h2>

        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600 sm:text-[15px]">
          Une sélection d’annonces particulièrement aimées pour leur style,
          leur fiabilité et leur attractivité.
        </p>
      </div>
