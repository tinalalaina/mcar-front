...
export const PopularVehicles = () => {
  const { data: vehicles = [], isLoading } = useSponsoredVehicles();
  ...
  return (
    <AnimatedSection className="pb-2 pt-1" delay={0}>
      <div className="mb-5">
        <span className="inline-flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.18em] text-amber-600/90">
        ...
        <h2 className="mt-3 text-2xl font-bold tracking-tight text-slate-950 sm:text-[1.8rem]">
          Les annonces sponsorisées les plus visibles du moment
        </h2>

        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600 sm:text-[15px]">
          Découvrez les véhicules mis en avant pour capter rapidement
          l’attention et faciliter votre choix.
        </p>
      </div>
